...
/// <remarks>
///   <para>
///     This interface is an alternative to <see cref="IEventHandler{T}" />. It is very slightly slower than
...
///   </para>
///   <para>
///     Please note that the batches can be very large, the worst case being the size of your ring buffer. It might be
...
interface IBatchEventHandler<T>
{
  /// <summary>
  ///   Called when a publisher has committed events to the <see cref="RingBuffer{T}" />. The
  ///   <see cref="IEventProcessor" /> will
  ...
  void OnBatch(Span<T> batch, long sequence);
