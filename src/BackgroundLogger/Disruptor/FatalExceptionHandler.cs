...
/// </summary>
sealed class FatalExceptionHandler<T> : IExceptionHandler<T>
{
  ...
  {
    var message =
      $"Exception processing sequence {sequence} for batch of {batch.Length} events, first event {batch[0]}: {ex}";
